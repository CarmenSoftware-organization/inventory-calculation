...
สรุป: รับ 30 หน่วย (฿1,000) → Issue 5 (฿166.65) + CN 1 (฿33.34) → คงเหลือ 24 หน่วย (฿800.01)
...
สรุป: รับ 14 หน่วย (฿480.03) → Issue 4+4 (฿273.02) → คงเหลือ 6 หน่วย (฿207.00), diff = ฿-0.03

> **หมายเหตุ**: AVG/unit คำนวณด้วย 4dp ค่าจาก Excel (2dp) อาจแตกต่างเล็กน้อย
